...
class PatchNormConv2D(keras.layers.Layer):
    ...
    def __init__(
        ...
        :param activation:
        :param use_bias:
        :param per_channel: whether to calculate mean and stddev for each channel
        (for each kernel patch) of the input or including the channel dimension in
        that.
        :returns:
        :rtype:
...
class EfficientPatchNormConv2D(keras.layers.Layer):
    """Notes:
